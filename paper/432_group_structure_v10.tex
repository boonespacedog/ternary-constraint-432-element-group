...
\title{Doubly Stochastic Matrices Over $\F_3$: \\ Binary Trace Stratification and the Impossibility of Trace-2}
...
\item \textbf{GitHub repository}: \\
  ...
  \end{itemize}
\item \textbf{Zenodo archive}: DOI \texttt{10.5281/zenodo.17443365} (permanent archival copy with version control)
\end{itemize}
